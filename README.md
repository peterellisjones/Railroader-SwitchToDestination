...
* If there are multiple destination tracks (like the two tracks at Whittier Saw Mill), pressing the button again will toggle between the tracks. (known bug: this doesn't currently work correctly at the interchanges -- it will always route to the same track)
